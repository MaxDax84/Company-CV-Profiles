    ...
    return (
      <div className="sm:col-span-2 flex items-start justify-between gap-4">
        <div className="grid sm:grid-cols-3 gap-4 flex-1">
          <div>
            <p className="text-xs text-muted-foreground/60 mb-0.5">Nome</p>
          ...
          <div>
            <p className="text-xs text-muted-foreground/60 mb-0.5">Località</p>
  ...
  return (
    <div className="sm:col-span-2 space-y-3">
      <div className="grid sm:grid-cols-3 gap-3">
        ...
        <div>
          <label className="text-xs text-muted-foreground/60 mb-1 block">Località</label>
          <input
      ...
      <div className="flex items-center gap-3">
        ...
        {status === "error" && <p className="text-xs text-red-400">Errore, riprova.</p>}
      </div>
    </div>
  );
}
