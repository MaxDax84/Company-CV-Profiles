...
const FAQ_ITEMS_IT: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'Ogni account riceve un credito di benvenuto gratuito. Un credito si usa per scaricare un PDF, adattare il CV a un annuncio, generare una lettera di presentazione o tradurre il CV in un\'altra lingua. Siamo in fase beta: per ora il servizio è gratuito, i costi verranno introdotti più avanti.',
  },
  {
...
const FAQ_ITEMS_EN: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'Every account gets one free welcome credit. A credit is used to download a PDF, tailor your CV to a job posting, generate a cover letter, or translate your CV into another language. We\'re in beta: the service is currently free, pricing will be introduced later.',
  },
  {
