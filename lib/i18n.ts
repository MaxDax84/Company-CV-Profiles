...
export const translations = {
  ...
  it: {
    ...
    generate: {
      ...
      stepTemplate: '3 · Scegli il template (scorri per l\'anteprima di ognuno)',
      ...
      generatingSteps: [
        ...
        'Scrittura del riepilogo professionale…',
      ...
      ctaReady: 'Genera il mio profilo →',
