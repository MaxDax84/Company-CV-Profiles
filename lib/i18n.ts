...
export const translations = {
  ...
  it: {
    ...
    generate: {
      ...
      stepTemplate: '2 · Scegli il template (scorri per l\'anteprima di ognuno)',
      ...
      ctaReady: 'Crea la mia pagina web →',
      ctaWaiting: 'Carica il tuo CV per iniziare',
      scoredTitle: 'Ecco il punteggio del tuo CV',
      scoredSubtitle: 'La nostra AI può migliorare i contenuti per alzare il punteggio — senza mai inventare nulla — e trasformarli in una pagina web pronta da condividere.',
      ctaProceed: 'Sì, crea la mia pagina web →',
