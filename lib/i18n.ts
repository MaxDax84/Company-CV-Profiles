...
export const translations = {
  en: {
    ...
    generate: {
      ...
      doneExpiry: 'The profile will be available for 90 days, then deleted automatically.',
  ...
  it: {
    ...
    generate: {
      ...
      doneExpiry: 'Il profilo sarà disponibile per 90 giorni, poi verrà eliminato automaticamente.',
