...
- For bio: max 140 characters, professional tone, third person. When the source summary has more distinctive content than fits, prioritize the most specific, differentiating skills or qualifiers (e.g. a named strategy, methodology, or niche specialization like "go-to-market strategy") over generic ones (e.g. "strategic partnerships", "strong background") — never let a specific, distinctive term get cut in favor of a vaguer one just to save space.
