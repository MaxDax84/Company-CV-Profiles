...
export default function ElonMuskPage() {
  return (
    <div className={dmSans.className} style={{ display: 'flex', minHeight: '100vh', background: darkBg, color: '#e2e8f0' }}>
      <style>{`
      ...
      <aside style={{
        ...
        display: 'flex', flexDirection: 'column', padding: '36px 28px 28px',
        zIndex: 100, overflowY: 'auto',
      }}>
        <Link href="/showcase" className={dmMono.className} style={{ fontSize: 10, color: '#374151', textDecoration: 'none', letterSpacing: '0.15em', marginBottom: 44, display: 'block' }}>← SHOWCASE</Link>
      ...
      <main style={{ marginLeft: 256, flex: 1 }}>
        ...
        {/* Ventures */}
        <section id="ventures" style={{ padding: '60px 64px', borderBottom: `1px solid ${border}` }}>
        ...
        {/* Skills */}
        <section id="skills" style={{ padding: '60px 64px', borderBottom: `1px solid ${border}`, background: 'rgba(255,255,255,0.01)' }}>
        ...
        <section id="education" style={{ padding: '60px 64px 80px' }}>
