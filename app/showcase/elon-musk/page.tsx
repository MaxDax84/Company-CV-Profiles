    ...
    <div style={{ fontFamily: DM_SANS_FONT, minHeight: '100vh', background: darkBg, color: '#e2e8f0', overflowX: 'hidden' }}>
      ...
      <div className="em-layout">
        ...
        <aside className="em-sidebar">
          <Link href="/showcase" className="em-back-mobile" style={{ fontFamily: DM_MONO_FONT, fontSize: 10, color: '#374151', textDecoration: 'none', letterSpacing: '0.15em' }}>← SHOWCASE</Link>

          {/* Identity */}
          <div style={{ marginBottom: 44 }}>
            <p style={{ fontFamily: DM_MONO_FONT, fontSize: 9, color: blue, letterSpacing: '0.25em', margin: '0 0 6px' }}>ELON REEVE</p>
            <p style={{ fontFamily: GROTESK_FONT, fontSize: 30, fontWeight: 700, lineHeight: 1, color: '#ffffff', letterSpacing: '-0.02em', margin: '0 0 8px' }}>MUSK</p>
            <p style={{ fontFamily: DM_MONO_FONT, fontSize: 9, color: '#374151', letterSpacing: '0.15em', margin: 0 }}>CEO · ENGINEER · FOUNDER</p>
          </div>

          {/* Nav */}
          <nav style={{ display: 'flex', flexDirection: 'column', gap: 2, marginBottom: 44 }}>
            <p style={{ fontFamily: DM_MONO_FONT, fontSize: 9, color: '#1f2937', letterSpacing: '0.2em', margin: '0 0 10px' }}>NAVIGATION</p>
          ...
          <div style={{ marginBottom: 'auto' }}>
            <p style={{ fontFamily: DM_MONO_FONT, fontSize: 9, color: '#1f2937', letterSpacing: '0.2em', margin: '0 0 14px' }}>KEY METRICS</p>
        ...
        <main className="em-main">
          ...
          <section id="overview" className="em-section-first" style={{ borderBottom: `1px solid ${border}`, background: `radial-gradient(ellipse at 80% 30%, rgba(59,130,246,0.06), transparent 55%)` }}>
            <p style={{ fontFamily: DM_MONO_FONT, fontSize: 10, color: blue, letterSpacing: '0.3em', margin: '0 0 28px' }}>// OVERVIEW</p>
          ...
          <section id="ventures" className="em-section" style={{ borderBottom: `1px solid ${border}` }}>
            <p style={{ fontFamily: DM_MONO_FONT, fontSize: 10, color: blue, letterSpacing: '0.3em', margin: '0 0 10px' }}>// VENTURES</p>
          ...
          <section id="skills" className="em-section" style={{ borderBottom: `1px solid ${border}`, background: 'rgba(255,255,255,0.01)' }}>
            <p style={{ fontFamily: DM_MONO_FONT, fontSize: 10, color: blue, letterSpacing: '0.3em', margin: '0 0 10px' }}>// SKILLS</p>
            <h2 style={{ fontFamily: GROTESK_FONT, fontSize: 'clamp(1.5rem, 3vw, 2.4rem)', fontWeight: 700, margin: '0 0 40px', letterSpacing: '-0.02em' }}>
          ...
          <section id="education" className="em-section" style={{ paddingBottom: 80 }}>
            <p style={{ fontFamily: DM_MONO_FONT, fontSize: 10, color: blue, letterSpacing: '0.3em', margin: '0 0 10px' }}>// EDUCATION & RECOGNITION</p>
            <h2 style={{ fontFamily: GROTESK_FONT, fontSize: 'clamp(1.5rem, 3vw, 2.4rem)', fontWeight: 700, margin: '0 0 40px', letterSpacing: '-0.02em' }}>
              Dropped out of Stanford. <span style={{ color: blue }}>After two days.</span>
            </h2>
            <div className="em-edu-grid">
              <div>
                <p style={{ fontFamily: DM_MONO_FONT, fontSize: 9, color: '#374151', letterSpacing: '0.15em', margin: '0 0 16px' }}>ACADEMIC</p>
              ...
              <div>
                <p style={{ fontFamily: DM_MONO_FONT, fontSize: 9, color: '#374151', letterSpacing: '0.15em', margin: '0 0 16px' }}>RECOGNITION</p>
