...
const content = {
  en: {
    ...
    footerDisclaimer: '🎭 This is a demo page. Maria Rossi is a fictional character created by Jobli for illustrative purposes.',
  ...
  it: {
    ...
    footerDisclaimer: '🎭 Questa è una pagina dimostrativa. Maria Rossi è un personaggio di fantasia creato da Jobli a scopo illustrativo.',
        ...
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 32 }}>
            ...
            <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.18)', margin: 0 }}>
              {c.footerBy} <Link href="/" style={{ color: em, textDecoration: 'none', fontWeight: 600 }}>Jobli</Link>
            </p>
          </div>
        </div>
      </section>
