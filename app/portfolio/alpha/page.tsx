    ...
    <div className={grotesk.className} style={{ background: dark, color: text, minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <nav className="mb-nav">
        <div className="mb-nav-inner">
          ...
          <div className="mb-nav-links">
            ...
            <Link href="/#portfolio" className="mb-nav-link" style={{ color: sub, fontSize: 12 }}>← Portfolio</Link>
          </div>
          <a href="#contact" className="mb-nav-cta">Contattami</a>
        </div>
      </nav>
      ...
      <section id="top" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', paddingTop: 60, position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 32px 96px', width: '100%', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '5px 14px', borderRadius: 999, background: 'rgba(255,255,255,0.04)', border: `1px solid ${border}`, marginBottom: 20 }}>
            ...
            <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', fontWeight: 500, letterSpacing: '0.05em' }}>Progetto dimostrativo · Personaggio di fantasia</span>
          </div>

          <p style={{ fontSize: 12, fontWeight: 600, color: gold, letterSpacing: '0.25em', textTransform: 'uppercase', margin: '0 0 24px', opacity: 0.8 }}>
            Chief Financial Officer · Milano, Italia
          </p>
          ...
          <p style={{ fontSize: 'clamp(1rem, 1.6vw, 1.15rem)', color: softText, maxWidth: 620, lineHeight: 1.8, margin: '0 0 48px', fontWeight: 300 }}>
            14 anni tra investment banking, manifatturiero e tech. Da analyst a CFO, ho costruito funzioni Finance dove non esistevano e guidato aziende attraverso Serie C, M&A e rinegoziazioni del debito.
          </p>
      ...
      <section id="about" className="mb-section" style={{ padding: '100px 32px', background: darkCard }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <p style={{ fontSize: 11, fontWeight: 600, color: gold, letterSpacing: '0.25em', textTransform: 'uppercase', margin: '0 0 16px', opacity: 0.8 }}>About</p>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80 }}>
            <div>
              <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: 700, color: '#fff', lineHeight: 1.12, margin: '0 0 28px', letterSpacing: '-0.02em' }}>
                La finanza non è un costo.<br /><span style={{ color: gold }}>È una leva strategica.</span>
              </h2>
              <p style={{ fontSize: 16, color: softText, lineHeight: 1.85, margin: '0 0 20px', fontWeight: 300 }}>
                Ho iniziato in una boutique M&A, dove ho imparato che i numeri da soli non bastano — contano le storie che raccontano. Da lì in poi, ogni ruolo ha aggiunto uno strato: il controlling industriale, la complessità delle scale-up tech, la pressione degli LP.
              </p>
              <p style={{ fontSize: 16, color: softText, lineHeight: 1.85, fontWeight: 300 }}>
                Oggi come CFO il mio lavoro è tradurre l&rsquo;ambizione del business in numeri che reggono — davanti a un board, a una banca, o a un acquirente. E costruire team che fanno lo stesso anche quando non ci sono io.
              </p>
            </div>
            <div>
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                {['🇮🇹 Italiano · Madrelingua', '🇬🇧 English · C1', '🇩🇪 Deutsch · B1'].map(l => (
      ...
      <section id="experience" className="mb-section" style={{ padding: '100px 32px', background: dark }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <p style={{ fontSize: 11, fontWeight: 600, color: gold, letterSpacing: '0.25em', textTransform: 'uppercase', margin: '0 0 16px', opacity: 0.8 }}>Percorso</p>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: 700, color: '#fff', lineHeight: 1.12, margin: '0 0 56px', letterSpacing: '-0.02em' }}>
            Quattro capitoli.<br /><span style={{ color: gold }}>Una direzione sola.</span>
          </h2>
      ...
      <section id="skills" className="mb-section" style={{ padding: '100px 32px', background: darkCard }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <p style={{ fontSize: 11, fontWeight: 600, color: gold, letterSpacing: '0.25em', textTransform: 'uppercase', margin: '0 0 16px', opacity: 0.8 }}>Competenze</p>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: 700, color: '#fff', lineHeight: 1.12, margin: '0 0 48px', letterSpacing: '-0.02em' }}>
            Finance end-to-end.<br /><span style={{ color: gold }}>Dal modello alla firma.</span>
          </h2>
          ...
          <div style={{ marginTop: 20, display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            {['CFA Level II · 2014', 'IFRS Specialist Cert. · 2013', 'SAP FI/CO Certified · 2017'].map(c => (
              <div key={c} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '9px 16px', background: dark, border: `1px solid ${goldBorder}`, borderRadius: 6 }}>
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: gold, opacity: 0.7 }} />
                <span style={{ fontSize: 13, color: softText }}>{c}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="contact" className="mb-section" style={{ padding: '100px 32px', background: dark, textAlign: 'center' }}>
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          <p style={{ fontSize: 11, fontWeight: 600, color: gold, letterSpacing: '0.25em', textTransform: 'uppercase', margin: '0 0 24px', opacity: 0.8 }}>Contatti</p>
          <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 3rem)', fontWeight: 700, color: '#fff', lineHeight: 1.12, margin: '0 0 16px', letterSpacing: '-0.02em' }}>
            Parliamo di<br /><span style={{ color: gold }}>finanza strategica.</span>
          </h2>
          <p style={{ fontSize: 16, color: softText, margin: '0 0 48px', lineHeight: 1.75, fontWeight: 300 }}>
            Disponibile per ruoli CFO, advisory finanziario e progetti di M&A.
          </p>
          ...
          <div style={{ borderTop: `1px solid ${border}`, paddingTop: 32 }}>
            <p style={{ fontSize: 12, color: sub, margin: '0 0 8px', fontStyle: 'italic' }}>
              🎭 Questa è una pagina dimostrativa. Marco Bianchi è un personaggio di fantasia creato da BeOnWeb a scopo illustrativo.
            </p>
            <p style={{ fontSize: 12, color: sub, margin: '0 0 6px' }}>© 2025 Marco Bianchi · Milano</p>
            <p style={{ fontSize: 12, color: sub, margin: 0 }}>
              Progettato da <Link href="/" style={{ color: gold, textDecoration: 'none', fontWeight: 600 }}>BeOnWeb</Link>
            </p>
          </div>
        </div>
      </section>
