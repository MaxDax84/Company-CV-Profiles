...
const content = {
  en: {
    ...
    infoRows: [
      ...
      ['🎓', 'MSc Finance · Vantage · Summa cum laude'],
    ...
    education: [
      { degree: 'MSc Finance & Banking', school: 'Università Vantage', year: '2007 – 2009', note: 'Summa cum laude' },
      { degree: 'BSc Business Administration', school: 'Università Metropolitana di Milano', year: '2004 – 2007', note: '' },
    ],
    certs: ['Chartered Investment Analyst Level II · 2014', 'International Reporting Standards Specialist Cert. · 2013', 'ERP Finance Module Certified · 2017'],
    contactLabel: 'Contact',
    contactHeading: "Let's talk",
    contactHeadingAccent: 'strategic finance.',
    contactSub: 'Available for CFO roles, financial advisory, and M&A projects.',
    footerDisclaimer: '🎭 This is a demo page. Marco Bianchi is a fictional character created by Jobli for illustrative purposes.',
  ...
  it: {
    ...
    education: [
      { degree: 'MSc Finance & Banking', school: 'Università Vantage', year: '2007 – 2009', note: '110/110 cum laude' },
      { degree: 'Laurea Triennale in Economia Aziendale', school: 'Università Metropolitana di Milano', year: '2004 – 2007', note: '' },
    ],
    certs: ['Chartered Investment Analyst Level II · 2014', 'International Reporting Standards Specialist Cert. · 2013', 'ERP Finance Module Certified · 2017'],
    ...
    footerDisclaimer: '🎭 Questa è una pagina dimostrativa. Marco Bianchi è un personaggio di fantasia creato da Jobli a scopo illustrativo.',
        ...
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          ...
          <div style={{ borderTop: `1px solid ${creamBorder}`, paddingTop: 32 }}>
            ...
            <p style={{ fontSize: 12, color: inkLight, margin: 0 }}>
              {c.footerBy} <Link href="/" style={{ color: gold, textDecoration: 'none', fontWeight: 600 }}>Jobli</Link>
            </p>
          </div>
        </div>
      </section>
