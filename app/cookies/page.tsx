          ...
          {lang === 'it' ? (
            <>
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1">
                  <li>
                    <strong className="text-foreground">Cookie tecnici / strettamente necessari</strong> — necessari al
              ...
              <div>
                ...
                <p>
                  Il sito <strong className="text-foreground">Jobli</strong> utilizza esclusivamente
                ...
                <p className="mt-3">
                  Il sito <strong className="text-foreground">non utilizza</strong>:
                </p>
                <ul className="list-disc list-inside mt-2 space-y-1">
                ...
                <p className="mt-3">
                  Poiché tutti i cookie utilizzati sono strettamente necessari al funzionamento del
                  servizio richiesto dall&apos;utente, ai sensi delle Linee Guida del Garante del 2021
                  <strong className="text-foreground"> non è richiesto un banner di consenso</strong> preventivo.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  le impostazioni del proprio browser. Nota: disabilitare i cookie di sessione
                  impedirà l&apos;accesso al tuo account.
                </p>
                <ul className="list-disc list-inside mt-2 space-y-1">
                  <li>
            ...
            <>
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1">
                  <li>
                    <strong className="text-foreground">Technical / strictly necessary cookies</strong> — necessary for
                  ...
                  <li>
                    ...
                    collect aggregate browsing statistics; consent is required unless fully anonymised.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p>
                  <strong className="text-foreground">Jobli</strong> only uses technical / strictly
                ...
                <p className="mt-3">
                  <strong className="text-foreground">Jobli does not use</strong>:
                </p>
                <ul className="list-disc list-inside mt-2 space-y-1">
                ...
                <p className="mt-3">
                  Since every cookie used is strictly necessary for the service you requested, under
                  the Italian Data Protection Authority&apos;s 2021 Guidelines{' '}
                  <strong className="text-foreground">no prior consent banner is required</strong>.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  disabling session cookies will prevent you from accessing your account.
                </p>
                <ul className="list-disc list-inside mt-2 space-y-1">
                  <li>
                    <a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Google Chrome</a>
